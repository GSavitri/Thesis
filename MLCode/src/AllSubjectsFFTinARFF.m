...
result=arffHeader(numberOfBins*N);
...
for i=1:length(subjects)
    ...
    if (isAutoCut)
        ...
        if (~isempty(index))
            ...
            [fftResult, scliceEventsPortion] = autoCutFFTinARFF(loadedsubject,subjectName, attribute, numberOfBins);
        ...
        result = strcat(result,'\n',getAllFTTinARFF(loadedsubject, attribute, numberOfBins));
    end
end 
