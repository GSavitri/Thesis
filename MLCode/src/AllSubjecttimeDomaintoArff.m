...
numberofTimeFeatures= 5;
%number of features will be N*number of Bins
result=arffHeaderFeatures(numberofTimeFeatures*N);
...
for i=1:length(subjects)
    ...
    if (isAutoCut)
        ...
        if (~isempty(index))
            ...
            [fftResult, scliceEventsPortion] = autoCutFeaturesinARFF(loadedsubject,subjectName, attribute);
        ...
        result = strcat(result,'\n',getAllFeaturesinARFF(loadedsubject, attribute));
    end
end 
